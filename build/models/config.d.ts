...
export type GroupMode = 'off' | 'manual' | 'schedule' | 'temperature' | 'humidity' | 'vpd' | 'combined' | 'monitorOnly' | 'maintenance';
export type ControllerType = 'off' | 'shadow' | 'twoPoint' | 'threePoint' | 'stepped' | 'timeProportional' | 'p' | 'pi' | 'pid' | 'custom';
export type SetpointSource = 'fixed' | 'dayNightProfile' | 'schedule' | 'phase' | 'externalState';
...
export type AirSystemMode = 'exhaustOnly' | 'linked' | 'ratioCoupled' | 'curveCoupled' | 'independent';
...
export type EffectCheckResult = 'confirmed' | 'weak' | 'notDetectable' | 'opposite' | 'disturbanceActive';
